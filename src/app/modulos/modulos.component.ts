...
import { FilasResolve } from '../services/filas.resolve';
import { ClearMenuResolve } from '../services/clearMenu.resolve';
import { HotkeysService, Hotkey } from 'angular2-hotkeys';
import { AppSistemaService } from '../services/app-sistema.service';
import { ApiRequestService } from '../services/api-request.service';

@Component({
  selector: 'app-modulos',
  templateUrl: './modulos.component.html',
  providers: [AuthService, ApiRequestService, AppSistemaService, FilasResolve]
})
